...
$contact = [
    "phone" => "+63 994 2148 865",
    "email" => "janisongianebustos@gmail.com",
    "github" => "https://github.com/jgianee",
    "linkedin" => "https://www.linkedin.com/in/janison-bustos-6789a9387/"
];
...
<head>
  ...
  <style>
    body { 
      ...
      background: linear-gradient(135deg, rgba(0,150,255,0.08), rgba(100,149,237,0.08)),
    ...
    header .left-info { display:flex; align-items:center; }
    header img { 
      width:120px; 
      height:120px; 
      border-radius:50%; 
      ...
      <div class="left">
        ...
        <div class="contact">
          ...
          <p><i class="fa fa-envelope"></i> 
            <a href="mailto:<?php echo $contact["email"]; ?>" style="color:#0047AB; text-decoration:none;">
              <?php echo $contact["email"]; ?>
            </a>
          </p>
          <p><i class="fa-brands fa-github"></i> 
            <a href="<?php echo $contact["github"]; ?>" target="_blank" style="color:#0047AB; text-decoration:none;">
              github.com/jgianee
            </a>
          </p>
          <p><i class="fa-brands fa-linkedin"></i> 
            <a href="<?php echo $contact["linkedin"]; ?>" target="_blank" style="color:#0047AB; text-decoration:none;">
              linkedin.com/in/janison-bustos
            </a>
          </p>
        </div>
